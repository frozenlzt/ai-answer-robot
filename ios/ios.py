...
def main():
    ...
    os.system('open https://www.baidu.com/s?wd=' + keyword);
...
if __name__ == "__main__":
    ...
    while '' == input("出现题目时请输入回车"):
        main()
        #appfrom = args.appfrom
        #os.system("mkdir -p screenshots/" + appfrom)
        #os.system("mv screenshot.png screenshots/" + appfrom + "/" + start_time + "_" + int(time.time()) + "_screenshot.png")
       # os.system("mv screenshot0.png screenshots/" + appfrom + "/" + start_time + "_" + int(time.time()) + "_screenshot0.png")
